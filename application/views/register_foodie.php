...
?>
<div class="foodie-register-page">
    <div class="foodie-register-form-container row">
        <div class="foodie-user-form col-12 d-flex justify-content-center flex-column">
            <h3>Register as Foodie</h3>
            <form class="form" id="foodie-register-form" method="POST" action="">
                ...
                <div class="form-row">
                    <div class="form-group col-md-9">
                        ...
                        <input type="text" name="name" class="form-control" id="inputCity" placeholder="Full Name" required>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="inputState">Preference</label>
                        <select name="preferences" id="inputState" class="form-control">
